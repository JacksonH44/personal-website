      ...
      <div className='w-screen h-[30vh] lg:h-[40vh] relative'>
        ...
        <div className='max-w-[1240px] mx-auto p-2 grid md:grid-col-5 gap-9 pt-8'>
          <div className='col-span-4'>
            ...
            <br></br>
            <p>
              Engineering involved mining multiple bioinformatics databases for hundreds of features relating to thousands of biology and healthcare topics. A large portion of problem-solving in these pipelines was payload optimizations for calling these database APIs that reduced average API latency by 48%. I also created and executed over 50 unit tests using the <strong>pytest</strong> framework, and leveraged these tests to create a continuous integration pipeline with GitHub Actions for the tool.
            </p>
